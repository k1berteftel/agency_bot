...
async def main():
    ...
    # подключаем роутеры
    dp.include_routers(user_router, admin_handlers, *get_dialogs())
    ...
    try:
        await dp.start_polling(bot, _session=session, _scheduler=scheduler, form_storage=form_storage)
